...
def read_file14(request):
	...
	urls = [
		...
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars8.json',
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars9.json',
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars10.json',
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars11.json',
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars12.json',
		'https://s3.ap-south-1.amazonaws.com/bitshopping/json+files/cars/cars13.json',
	]
